...
//新增
                   @{@"identifier": @"DYYYfollowpp", @"title": @"主页关注二次确认", @"detail": @"", @"cellType": @6, @"imageName": @"ic_userplus_outlined_20"},
            ...
            hideSettingItem.cellTappedBlock = ^{
                ...
                NSArray *mainUiSettings = @[
                    ...
                    @{@"identifier": @"DYYYwMessageButton", @"title": @"隐藏底栏我", @"detail": @"", @"cellType": @6, @"imageName": @"ic_eyeslash_outlined_16"},
